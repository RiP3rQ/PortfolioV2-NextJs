...
export const aboutData = {
  backgroundInfo: `Cześć, jestem Rafał Pompa i chcę zostać Full Stack Developerem. Mimo braku komeryjnego 
    doświadczenia, posiadam już dość dużą wiedzę w zakresie programowania, którą staram się ciągle rozwija. 
    Jestem osobą zdyscyplinowaną, rządną nowych wyzwań i nieustannie poszukującą nowej wiedzy. 
    Dzięki temu łatwo przyswajam nowe umiejętności oraz technologie. Moją siłą jest kreatywność 
